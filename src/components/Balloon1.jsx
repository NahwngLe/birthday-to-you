...
const Balloon1 = () => {
    const balloons = Array.from({ length: 50 }).map((_, index) => {
        ...
        return (
            ...
            >
                <img src="ballon1.svg" alt="Balloon" width={size} height={size} />
            </motion.div>
        );
    });
    ...
    const balloons2 = Array.from({ length: 50 }).map((_, index) => {
        ...
        return (
            <motion.div
                ...
                className="absolute bottom-0 z-0"
            >
                <img src="ballon2.svg" alt="Balloon" width={size} height={size} />
            </motion.div>
        );
    });
    ...
    const balloons3 = Array.from({ length: 50 }).map((_, index) => {
        ...
        return (
            <motion.div
                ...
                className="absolute bottom-0 z-0"
            >
                <img src="ballon3.svg" alt="Balloon" width={size} height={size} />
            </motion.div>
        );
    });
